...
?>
<div class="internal">
  <h1 class="basic_page"  <?php print $title_attributes; ?>><?php print $title; ?></h1>
					...
					if($box->field_url['und'][0]['value']){
						...
						print '<div class="boxes-wrapper">
							<table>
								<tr>
									<td width="675">
										<h2 class="box-title">'.$box->field_title['und'][0]['value'].'</h2>
										<p class="box-body">'.$box->field_footer_text['und'][0]['value'].'</p>
									</td>
									<td>'.theme_image_style(array('style_name'=>'services', 'path'=>$box->field_top_image['und'][0]['uri'], 'alt'=>$box->field_top_image['und'][0]['alt'], 'title'=>$box->field_top_image['und'][0]['title'] )).'</td>
								</tr>
							</table>
						</div>';
					}
